...
class TestAdminNamespaceRPC(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestAdminNamespaceRPC("test_admin_addPeer_error_no_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_addPeer_error_wrong_type_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_addPeer_error_wrong_value_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_addPeer_success"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_addPeer_stopped_node_success"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_addPeer_invalid_node_success"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_removePeer_success"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_removePeer_error_no_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_removePeer_error_wrong_type_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_removePeer_error_wrong_value_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_peers_success"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_peers_success_wrong_value_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_datadir_success"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_datadir_success_wrong_value_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_nodeInfo_success_wrong_value_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_nodeInfo_success"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_stopRPC_success_using_ws"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_stopRPC_error_http_rpc_not_running_using_ws"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startRPC_success_using_ws"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_stopRPC_success_wrong_value_param_using_ws"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startRPC_success_no_param_using_ws"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startRPC_error_wrong_type_param1_using_ws"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startRPC_error_wrong_type_param2_using_ws"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startRPC_error_wrong_type_param3_using_ws"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startRPC_error_wrong_type_param4_using_ws"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startRPC_error_wrong_value_param1_using_ws"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startRPC_error_already_running_using_ws"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_stopWS_success_using_rpc"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startWS_success_using_rpc"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_stopWS_success_wrong_value_param_using_rpc"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_stopWS_error_ws_not_running_using_rpc"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startWS_error_wrong_type_param1_using_rpc"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startWS_error_wrong_type_param2_using_rpc"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startWS_error_wrong_type_param3_using_rpc"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startWS_error_wrong_type_param4_using_rpc"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startWS_error_wrong_value_param1_using_rpc"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startWS_success_no_param_using_rpc"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_startWS_error_already_running_using_rpc"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_exportChain_success"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_exportChain_error_already_exist"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_exportChain_error_no_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_importChain_success"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_importChain_error_no_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_importChain_error_wrong_type_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_importChain_error_wrong_value_param"))
        suite.addTest(TestAdminNamespaceRPC("test_admin_nodeConfig_success"))
