...
class TestKaiaNamespaceGasRPC(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestKaiaNamespaceGasRPC("test_kaia_maxPriorityFeePerGas_success"))
        suite.addTest(TestKaiaNamespaceGasRPC("test_kaia_feeHistory_success"))
